...
!$OMP PRIVATE(is,nrc,nrci,ist,jst,irc,zlflm) &
...
! inner part of muffin-tin
        do irc=1,nrci
          ...
          t1=socfr(irc,ias)
          wfmt4(1:lmmaxinr,irc,1)=wfmt4(1:lmmaxinr,irc,1)+t1*zlflm(1:lmmaxinr,3)
          wfmt4(1:lmmaxinr,irc,2)=wfmt4(1:lmmaxinr,irc,2)-t1*zlflm(1:lmmaxinr,3)
          if (ncmag) wfmt4(1:lmmaxinr,irc,3)= &
           wfmt4(1:lmmaxinr,irc,3)+t1*(zlflm(1:lmmaxinr,1) &
           +cmplx(aimag(zlflm(1:lmmaxinr,2)),-dble(zlflm(1:lmmaxinr,2)),8))
        end do
