...
!BOI
! !TITLE: {\huge{\sc The Elk Code Manual}}\\ \Large{\sc Version 2.3.16}\\ \vskip 20pt \includegraphics[height=1cm]{elk_silhouette.pdf}
...
!   Aldo Romero Castro, Koichi Kitahara, James Glasbrenner, Konrad Bussmann and
!   Igor Mazin. Special mention of David Singh's very useful book on the LAPW
...
!    iterative first-variational eigenvalue equation solver & integer & 30}
!   See {\tt tseqit}.
!
!   \block{ntemp}{
...
!
!   \block{tseqit}{
!   {\tt tseqit} & set to {\tt .true.} if the first-variational eigenvalue
