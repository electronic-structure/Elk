...
! tseqr is .true. if the first-variational eigenvalue equation is to be solved
! as a real symmetric problem
logical tseqr
! tseqit is .true. if the first-variational eigenvalue equation is to be solved
! iteratively
logical tseqit
! minimum and maximum allowed number of eigenvalue equation iterations
integer minseqit,maxseqit
